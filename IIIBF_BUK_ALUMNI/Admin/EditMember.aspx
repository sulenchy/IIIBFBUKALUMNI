<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditMember.aspx.cs" Inherits="IIIBF_BUK_ALUMNI.Admin.EditMember" %>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <label runat="server" for="Membership">Membership</label>
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="Val_Membership" ControlToValidate="Membership"
                    ...
                    <label for="Position" class="control-label">Position</label>
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="Val_Position" ControlToValidate="Position" CssClass="text-danger" ErrorMessage="The Position field is required." />
